...
[![Telegram URL](https://bungdus.com/wp-content/uploads/2020/12/Kenapa-Bot-Telegram-Tidak-Membalas-Chat.jpg)] 
</h1>
...
- Клонировать проект командой: git clone `https://gitlab.skillbox.ru/maksim_riabko/python_basic_diploma.git`
...
- Склонируйте этот репозиторий в папку проекта `https://gitlab.skillbox.ru/maksim_riabko/python_basic_diploma.git`
